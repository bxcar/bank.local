...
$meta_fields = array(
    ...
    array(
        'label' => 'Ссылка',
        'desc' => 'Ссылка на кредит',
        'id' => 'credit_link', // даем идентификатор.
        'type' => 'link',  // Указываем тип поля.
        'value_link' => get_permalink( $_GET['post'] )
    )
,
        ...
        <br /><span class="description">' . $field['desc'] . '</span>';
            ...
            case 'link':
                ...
                if($meta) {
                    ...
                    echo $field['value_link'];
                }
                echo '" size="30" /><br /><span class="description">' . $field['desc'] . '</span>';
                break;
            case 'textarea':
